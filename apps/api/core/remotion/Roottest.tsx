...
import { Main, MainProps, Scene } from './factory/MainTest';
...
export const RemotionRoot: React.FC = () => {
  return (
    <Composition
      ...
      defaultProps={{
        scenes: [
          { template: 'sales-issue', durationInFrames: 480, props: {} },
          { template: '3pillars', durationInFrames: 120, props: {} },
          { template: 'circleFeatures', durationInFrames: 200, props: {} },
          { template: 'planning', durationInFrames: 210, props: {} },
          { template: 'delivery', durationInFrames: 500, props: {} },
          { template: 'salesgoup', durationInFrames: 150, props: {} },
          { template: 'outro', durationInFrames: 90, props: {} },
        ],
